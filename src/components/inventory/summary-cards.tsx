...
const TONS: Record<NonNullable<CarteInventaire["tone"]>, string> = {
  primary: "bg-primary-soft text-primary",
  success: "bg-success/10 text-success",
  warning: "bg-amber-500/10 text-amber-600",
};

export function InventorySummaryCards({ cartes }: { cartes: CarteInventaire[] }) {
  return (
